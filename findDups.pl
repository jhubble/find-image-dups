...
# Get the list first:
# find /mnt/d/sortedByYear/ -type 'f' -ls> allFiles1.txt ; find /mnt/d/tmpMove/ -type 'f' -ls >> allFiles1.txt ; cat allFiles1.txt |cut -c55- |sort -n > myFiles.txt
# This will produce output that can be run through bash
open F, "myFiles.txt";
